...
import CustomTextInput from '../src/components/molecules/CustomTextInput';
...
describe('CustomTextInput', () => {
  ...
  test('handles text change', () => {
    ...
    const {getByPlaceholderText} = render(
      <CustomTextInput placeholder="Enter Text" onChangeText={onChangeTextMock} />,
    );
    const input = getByPlaceholderText('Enter Text');
  ...
  test('passes additional props to TextInput', () => {
    const {getByTestId} = render(
      <CustomTextInput placeholder="Enter Text" testID="customTextInput" />,
    );
